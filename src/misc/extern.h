...
// NOTE: LS front-UI app (menu-bar owner) — SHM read, no RPC. ASN→pid via
// _LSCopyApplicationInformationItem("pid"); both results caller-owned (CFRelease).
typedef CFTypeRef LSASNRef;
#define kLSDefaultSessionID (-2)
extern LSASNRef _LSCopyFrontUIApplication(int sessionID);
extern CFTypeRef _LSCopyApplicationInformationItem(int sessionID, LSASNRef asn, CFStringRef key);
