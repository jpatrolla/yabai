...
enum sa_opcode
{
    ...
    SA_OPCODE_WINDOW_SCALE_CUSTOM   = 0x0E,
    SA_OPCODE_WINDOW_SCALE_FORCED   = 0x0F,
    SA_OPCODE_WINDOW_SCALE_FORCED_TX = 0x17,
    SA_OPCODE_WINDOW_ANIMATE_FRAME  = 0x10,
    SA_OPCODE_WINDOW_WARP           = 0x18,
    SA_OPCODE_WINDOW_SWAP_PROXY_IN  = 0x11,
    SA_OPCODE_WINDOW_SWAP_PROXY_OUT = 0x12,
    SA_OPCODE_WINDOW_ORDER          = 0x13,
    SA_OPCODE_WINDOW_ORDER_IN       = 0x14,
    SA_OPCODE_WINDOW_LIST_TO_SPACE  = 0x15,
    SA_OPCODE_WINDOW_TO_SPACE       = 0x16,
};
