...
enum sa_opcode
{
    ...
    SA_OPCODE_WINDOW_SWAP_PROXY_IN  = 0x0F,
    SA_OPCODE_WINDOW_SWAP_PROXY_OUT = 0x10,
    SA_OPCODE_WINDOW_ORDER          = 0x11,
    SA_OPCODE_WINDOW_ORDER_IN       = 0x12,
    SA_OPCODE_WINDOW_LIST_TO_SPACE  = 0x13,
    SA_OPCODE_WINDOW_TO_SPACE       = 0x14,
};
