...
*mission_control_thumbnails_enabled* ['<BOOL_SEL>']::
    ...
    Off by default. The *space --toggle mission-control-thumbnails* argument forces this on for a single invocation regardless of the config value.
...
*--toggle* 'padding|gap|mission-control|mission-control-thumbnails|show-desktop'::
